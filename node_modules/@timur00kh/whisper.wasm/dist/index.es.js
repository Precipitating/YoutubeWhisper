  ...
  async *streamimg(e, t = {}) {
    ...
    for await (const s of o) {
      ...
      const { timeoutError: m, clear: u } = R(r, "Transcribe timeout"), h = () => this.whisperService.transcribe(
        ...
        this.logger.debug("Transcription done in session then"), g = !0, n += f, u(), a == null || a(void 0);
      }).catch((l) => {
...
class A {
  constructor(e) {
    this.wasmModule = null, this.instance = null, this.modelFileName = "whisper.bin", this.isTranscribing = !1, this.bus = new D(), this.modelData = null, this.logger = new b((e == null ? void 0 : e.logLevel) ?? b.levels.ERROR, "WhisperWasmService"), e != null && e.init && this.loadWasmScript();
  }
